...
public class SphericalPlayerActivity extends AppCompatActivity {
    ...
    public SphericalVideoPlayer videoPlayer;
        protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        String s =getIntent().getExtras().getString("url");
        //Toast.makeText(this,s,Toast.LENGTH_LONG).show();
            String SAMPLE_VIDEO_PATH;
            if(s!=null)
           SAMPLE_VIDEO_PATH = s;
            else
                SAMPLE_VIDEO_PATH="android.resource://com.oculus.sample/raw/" + R.raw.closer;
            // getIntent().getExtras().getString("url");
           // Toast.makeText(this,SAMPLE_VIDEO_PATH,Toast.LENGTH_LONG).show();
               //"android.resource://com.oculus.sample/raw/" + R.raw.sample360;
